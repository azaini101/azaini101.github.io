...
function toggleButtonText() {
    ...
    if(button.innerText == "Newest to Oldest"){
...
function sortByDateNew(){
    ...
    while(switching)
    {
        ...
        for(i = 0; i < (b.length-1); i++)
        {
            ...
            string = string.substring(string.lastIndexOf(":")+2, string.lastIndexOf("."));
            ...
            string1 = string1.substring(string1.lastIndexOf(":")+2, string1.lastIndexOf("."));
